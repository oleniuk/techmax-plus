...
const TOKEN = '6718575765:AAFSOk7SWEDAIblXtW3ymHe5NKdMqXmE1nY';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!empty($_POST['name']) && !empty($_POST['productname'])) {
		...
		if (isset($_POST['productname']) && !empty($_POST['productname'])) {
			$txt .= "Додав товар: " . strip_tags(trim(urlencode($_POST['productname']))) . "%0A";
		}
